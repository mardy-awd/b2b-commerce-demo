...
export function setupPageModel(
    ...
    const pageWithDefaultTitle =
        pageModel.type === "Page" &&
        pageModel.translatableFields &&
        pageModel.translatableFields["title"] &&
        pageModel.translatableFields["title"][language.id] === "Page";
    ...
    if (pageDefinition.hasEditableTitle && (shouldResetTitle || hasNoTitleYet || pageWithDefaultTitle)) {
